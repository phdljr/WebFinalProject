...
<<<<<<< HEAD
  <div class="MovieDetail">
    ...
    <div class="movieContent">
      ...
      <h7>감독 : {{movieDetail.director}} / 배우 : {{movieDetail.actors}}</h7><br>
      <h7>장르 : {{movieDetail.genre}}</h7><br>
      <h7>개봉일: {{movieDetail.openingDate}}</h7><br>
      <b-button
        ref="cancel"
...
>>>>>>> 5b3f7e4f3c59146b072aefe36d8a343f6218d154
    </div>
...
<<<<<<< HEAD
  <div class="movieGraph">
    <movie-detail-chart-vue :ageData="movieDetail.ageChart" :sexData="movieDetail.sexChart"></movie-detail-chart-vue>
  </div>
