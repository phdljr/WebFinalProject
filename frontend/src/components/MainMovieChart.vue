        ...
        <div>
            ...
            <b-list-group horizontal id="movieChart">
                ...
                <div class="swipeButton">
                    <button v-if="page!=0"><b-icon icon="arrow-left-circle" size="3x" @click="page = page-1"/></button>
                </div>
                </b-list-group-item>
                <b-list-group-item :key="key" v-for="(movie, key) in listMovieChart">
                    <b-overlay :show="showOverlayList[key]" rounded="sm" @shown="onShown" @hidden="onHidden">
                    <b-card
                        :title="movie.title"
                ...
                <b-list-group-item class="d-flex justify-content-between align-items-center">
                    <div class="swipeButton">
                        <button v-if="page!=maxPage"><b-icon icon="arrow-right-circle" size="3x" @click="page = page+1"/></button>
                    </div>
                </b-list-group-item>
            </b-list-group>
        </div>
